...
match mode:
    case "+":
        print(sum(int(p.x),int(p.y)))
    case "-":
        print(sub(int(p.x),int(p.y)))
    case "*":
        print(mul(int(p.x),int(p.y)))
    case "/":
        print(divide(int(p.x),int(p.y)))
    case "%":
        print(perc(int(p.x),int(p.y)))
    case "**":
        print(pot(int(p.x),int(p.y)))